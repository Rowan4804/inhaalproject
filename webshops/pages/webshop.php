...
if(isset($_POST["zoeken"]) && !empty($_POST["patroon"])){
    ...
    $sql = "SELECT * FROM album WHERE titel LIKE %$patroon%' ||
...
foreach($albums as $album) {
    ...
    name='aantal[$lu]' id='aantal[$lus]'value='0' />";
    $lus++;
}
echo
"<input type='hidden' name='lus' id='lus' value'".$lus."'?>";
?>
<-- winkelmandje aan- en uitzetten -->echo
