function showWinkelmandje() {
    ...
    rijen = "<table><th width='120'>Titel</th><th>Artiest</th>"+"<th>Genre</th><th>Prijs</th><th>Aantal</th><th>Verwijderen</th>";
    rij = "";
    ...
    for(x=0; x<lus; x++){
        if(document.getElementById("aantal["+ x +"]").value==0)continue;
            ...
            rij += "<td width='120'>" + titel + "</td>" + "<td>" + artiest + "</td>" + "<td>" + genre + "</td>" + "<td>" + prijs + "</td>" + "<td>" + aantal + "</td>" + "<td onclick='deleterij(" + x + ");'>&#10008;</td></tr>";
            rijen += rij;
    }
    rijen += "</table>";
